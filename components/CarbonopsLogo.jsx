...
const CarbonopsLogo1 = () => {
    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 947.44 587.89" >
            ...
            <path fill="#ffffff" d="M302.42,498.47h-83.2l-30.06-187.49h-.79l-29.29,187.49h-83.6L0,191.94h83.89l34.03,190.46h.79l33.66-190.46h75.05l32.93,193.44h.8l34.9-193.44h84.19l-29.71,187.49Z" />
        </svg>
    );
};
